...
{
    private class AutoOutputGraphType_Human : ObjectGraphType<Human>
    {
        public AutoOutputGraphType_Human()
        {
            ...
            ConditionalAddField(ConstructField_HomePlanet());
        }
        ...
        public FieldType? ConstructField_Id()
        {
            ...
            fieldType.Resolver = new FuncFieldResolver<string>(context => ((Human)context.Source!).Id);
        ...
        public FieldType? ConstructField_Name()
        {
            ...
            // configure resolver
            fieldType.Resolver = new FuncFieldResolver<string>(context => ((Human)context.Source!).Name);
        ...
        public FieldType? ConstructField_GetFriends()
        {
            ...
            {
                var source = (Human)context.Source!;
        ...
        public FieldType? ConstructField_AppearsIn()
        {
            ...
            // configure resolver
            fieldType.Resolver = new FuncFieldResolver<Episodes[]>(context => ((Human)context.Source!).AppearsIn);

            return fieldType;
        }

        public FieldType? ConstructField_HomePlanet()
        {
            var fieldType = new FieldType()
            {
                Name = "HomePlanet",
            ...
            // configure resolver
            fieldType.Resolver = new FuncFieldResolver<string?>(context => ((Human)context.Source!).HomePlanet);
