...
### Running on .NET Core
The GraphQL.GraphiQLCore project runs on `.NET Core 2.0`. You can run from Visual Studio Code or from the command line using `dotnet run`. When you run the project, you will see the GraphiQL editor open.
