...
All input errors generated by the GraphQL framework derive from `DocumentError`. Below is a list of error messages and their respective error classes and codes:
