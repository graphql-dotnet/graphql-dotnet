...
public class ScopedAttributeTests
{
    ...
    public async Task ScopedMethodWorks()
    {
        ...
        (await scopedField.Middleware!.ResolveAsync(context, scopedField.Resolver!.ResolveAsync)).ShouldBe("0 1");
        Class1.DisposedCount.ShouldBe(1);
        (await scopedField.Middleware!.ResolveAsync(context, scopedField.Resolver!.ResolveAsync)).ShouldBe("0 1");
        Class1.DisposedCount.ShouldBe(2);
        (await scopedAsyncField.Middleware!.ResolveAsync(context, scopedAsyncField.Resolver!.ResolveAsync)).ShouldBe("0 1");
