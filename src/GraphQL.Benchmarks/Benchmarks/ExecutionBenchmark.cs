...
namespace GraphQL.Benchmarks
{
    ...
    public class ExecutionBenchmark : IBenchmark
    {
        ...
        public void GlobalSetup()
        {
            ...
            _cachedExecuter = new DocumentExecuter(new GraphQLDocumentBuilder(), new DocumentValidator(), new ComplexityAnalyzer(), new MemoryDocumentCache(100000, TimeSpan.FromHours(2)));
        }
