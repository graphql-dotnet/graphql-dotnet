...
namespace GraphQL.Benchmarks
{
    ...
    public class ValidationBenchmark : IBenchmark
    {
        ...
        private IValidationResult Validate(Document document) => _validator.ValidateAsync(null, _schema, document, document.Operations.First()).GetAwaiter().GetResult().validationResult;
