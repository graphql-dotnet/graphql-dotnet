...
public static class KnownSymbolsProvider
{
    ...
    public static KnownSymbols Transform(Compilation compilation)
    {
        ...
        {
            AotQueryTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_QUERY_TYPE_ATTRIBUTE),
            AotMutationTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_MUTATION_TYPE_ATTRIBUTE),
            AotSubscriptionTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_SUBSCRIPTION_TYPE_ATTRIBUTE),
            AotOutputTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_OUTPUT_TYPE_ATTRIBUTE),
            AotInputTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_INPUT_TYPE_ATTRIBUTE),
            AotGraphTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_GRAPH_TYPE_ATTRIBUTE),
            AotTypeMappingAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_TYPE_MAPPING_ATTRIBUTE),
            AotListTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_LIST_TYPE_ATTRIBUTE),
            AotRemapTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_REMAP_TYPE_ATTRIBUTE),
            ...
            IgnoreAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.IGNORE_ATTRIBUTE),
            DoNotMapClrTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.DO_NOT_MAP_CLR_TYPE_ATTRIBUTE),
            ClrTypeMappingAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.CLR_TYPE_MAPPING_ATTRIBUTE),
            MemberScanAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.MEMBER_SCAN_ATTRIBUTE),
            ...
            GraphQLConstructorAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.GRAPHQL_CONSTRUCTOR_ATTRIBUTE),
            InstanceSourceAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.INSTANCE_SOURCE_ATTRIBUTE),
            InputTypeAttributeT = compilation.GetTypeByMetadataName(Constants.AttributeNames.INPUT_TYPE_T_ATTRIBUTE),
            InputTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.INPUT_TYPE_ATTRIBUTE),
            InputBaseTypeAttributeT = compilation.GetTypeByMetadataName(Constants.AttributeNames.INPUT_BASE_TYPE_T_ATTRIBUTE),
            InputBaseTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.INPUT_BASE_TYPE_ATTRIBUTE),
            OutputTypeAttributeT = compilation.GetTypeByMetadataName(Constants.AttributeNames.OUTPUT_TYPE_T_ATTRIBUTE),
            OutputTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.OUTPUT_TYPE_ATTRIBUTE),
            OutputBaseTypeAttributeT = compilation.GetTypeByMetadataName(Constants.AttributeNames.OUTPUT_BASE_TYPE_T_ATTRIBUTE),
            OutputBaseTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.OUTPUT_BASE_TYPE_ATTRIBUTE),
            BaseGraphTypeAttributeT = compilation.GetTypeByMetadataName(Constants.AttributeNames.BASE_GRAPH_TYPE_T_ATTRIBUTE),
            BaseGraphTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.BASE_GRAPH_TYPE_ATTRIBUTE),
