...
public static class KnownSymbolsProvider
{
    ...
    public static KnownSymbols Transform(Compilation compilation)
    {
        ...
        {
            AotQueryTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_QUERY_TYPE),
            AotMutationTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_MUTATION_TYPE),
            AotSubscriptionTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_SUBSCRIPTION_TYPE),
            AotOutputTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_OUTPUT_TYPE),
            AotInputTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_INPUT_TYPE),
            AotGraphTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_GRAPH_TYPE),
            AotTypeMappingAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_TYPE_MAPPING),
            AotListTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_LIST_TYPE),
            AotRemapTypeAttribute = compilation.GetTypeByMetadataName(Constants.AttributeNames.AOT_REMAP_TYPE),
