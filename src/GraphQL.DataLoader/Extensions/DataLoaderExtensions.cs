...
#pragma warning disable CS8619 // Nullability of reference types in value doesn't match target type.
    /// <inheritdoc cref="ObjectFieldBuilder{TSourceType, TReturnType}.Resolve(IFieldResolver)"/>
    public static ObjectFieldBuilder<TSourceType, TReturnType> ResolveAsync<TSourceType, TReturnType>(this ObjectFieldBuilder<TSourceType, TReturnType> builder, Func<IResolveFieldContext<TSourceType>, IDataLoaderResult<TReturnType>> resolve)
        => builder.Resolve(new FuncFieldResolver<TSourceType, IDataLoaderResult<TReturnType>>(resolve));

    /// <inheritdoc cref="ObjectFieldBuilder{TSourceType, TReturnType}.Resolve(IFieldResolver)"/>
    public static ObjectFieldBuilder<TSourceType, TReturnType> ResolveAsync<TSourceType, TReturnType>(this ObjectFieldBuilder<TSourceType, TReturnType> builder, Func<IResolveFieldContext<TSourceType>, Task<IDataLoaderResult<TReturnType>>> resolve)
    ...
    /// <inheritdoc cref="ObjectFieldBuilder{TSourceType, TReturnType}.Resolve(IFieldResolver)"/>
    public static ObjectFieldBuilder<TSourceType, TReturnType> ResolveAsync<TSourceType, TReturnType>(this ObjectFieldBuilder<TSourceType, TReturnType> builder, Func<IResolveFieldContext<TSourceType>, IDataLoaderResult<IDataLoaderResult<TReturnType>>> resolve)
        => builder.Resolve(new FuncFieldResolver<TSourceType, IDataLoaderResult<IDataLoaderResult<TReturnType>>>(resolve));

    /// <inheritdoc cref="ObjectFieldBuilder{TSourceType, TReturnType}.Resolve(IFieldResolver)"/>
    public static ObjectFieldBuilder<TSourceType, TReturnType> ResolveAsync<TSourceType, TReturnType>(this ObjectFieldBuilder<TSourceType, TReturnType> builder, Func<IResolveFieldContext<TSourceType>, Task<IDataLoaderResult<IDataLoaderResult<TReturnType>>>> resolve)
    ...
    /// <inheritdoc cref="ObjectFieldBuilder{TSourceType, TReturnType}.Resolve(IFieldResolver)"/>
    public static ObjectFieldBuilder<TSourceType, TReturnType> ResolveAsync<TSourceType, TReturnType>(this ObjectFieldBuilder<TSourceType, TReturnType> builder, Func<IResolveFieldContext<TSourceType>, IDataLoaderResult<IDataLoaderResult<IDataLoaderResult<TReturnType>>>> resolve)
    ...
    /// <inheritdoc cref="ObjectFieldBuilder{TSourceType, TReturnType}.Resolve(IFieldResolver)"/>
    public static ObjectFieldBuilder<TSourceType, TReturnType> ResolveAsync<TSourceType, TReturnType>(this ObjectFieldBuilder<TSourceType, TReturnType> builder, Func<IResolveFieldContext<TSourceType>, Task<IDataLoaderResult<IDataLoaderResult<IDataLoaderResult<TReturnType>>>>> resolve)
