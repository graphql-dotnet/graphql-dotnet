...
public class PersistedDocumentTests
{
    ...
    [InlineData(7, """{}""", """{"errors":[{"message":"The request must have a documentId parameter.","extensions":{"code":"DOCUMENT_ID_MISSING","codes":["DOCUMENT_ID_MISSING"]}}]}""")]
    [InlineData(8, """{"documentId":"sha256:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef","query":"{test}"}""", """{"errors":[{"message":"The request must not have both query and documentId parameters.","extensions":{"code":"INVALID_REQUEST","codes":["INVALID_REQUEST"]}}]}""")]
