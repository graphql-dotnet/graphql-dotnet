...
public class Bug3444
{
    ...
    public void Rethrow_Schema_Initialization_Failure()
    {
        ...
        string msg1 = Should.Throw<InvalidOperationException>(() => schema.Initialize()).Message;
        string msg2 = Should.Throw<InvalidOperationException>(() => schema.Initialize()).Message;
        msg1.ShouldBe(msg2);
    }
