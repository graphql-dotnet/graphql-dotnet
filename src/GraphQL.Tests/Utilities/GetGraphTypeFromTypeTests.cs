...
namespace GraphQL.Tests.Utilities
{
    public class GetGraphTypeFromTypeTests
    {
        ...
        [InlineData(typeof(IEnumerable<Uri>), true, TypeMappingMode.UseBuiltInScalarMappings, typeof(ListGraphType<NonNullGraphType<UriGraphType>>))]
        ...
        [InlineData(typeof(IEnumerable<IEnumerable<int>>), false, TypeMappingMode.UseBuiltInScalarMappings, typeof(NonNullGraphType<ListGraphType<NonNullGraphType<ListGraphType<NonNullGraphType<IntGraphType>>>>>))]
        //output mapping mode
        ...
        [InlineData(typeof(IEnumerable<Uri>), true, TypeMappingMode.OutputType, typeof(ListGraphType<NonNullGraphType<GraphQLClrOutputTypeReference<Uri>>>))]
        [InlineData(typeof(IEnumerable<MyClass>), true, TypeMappingMode.OutputType, typeof(ListGraphType<NonNullGraphType<GraphQLClrOutputTypeReference<MyClass>>>))]
