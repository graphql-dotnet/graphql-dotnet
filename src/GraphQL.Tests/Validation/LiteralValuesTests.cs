...
{
    [Theory]
    [InlineData("{ str (arg: 3) }", null, false, "INVALID_LITERAL", "Invalid literal for field 'str' argument 'arg'. Unable to convert '3' literal from AST representation to the scalar type 'String'", 1, 13)]
    [InlineData("{ str (arg: 3) }", null, true, "ARGUMENTS_OF_CORRECT_TYPE", "Argument 'arg' has invalid value. Expected type 'String', found 3.", 1, 8)]
    [InlineData("{ str (arg2: {}) }", null, false, "INVALID_LITERAL", "Invalid literal for field 'str' argument 'arg2'. Error parsing dictionary", 1, 14)]
    [InlineData("{ str (arg2: {}) }", null, true, "INVALID_LITERAL", "Invalid literal for field 'str' argument 'arg2'. Error parsing dictionary", 1, 14)]
    [InlineData("""{ str (arg3: "3") }""", null, false, "INVALID_LITERAL", "Invalid literal for field 'str' argument 'arg3'. Could not parse date. Expected yyyy-MM-dd. Value: 3", 1, 14)]
    [InlineData("""{ str (arg3: "3") }""", null, true, "ARGUMENTS_OF_CORRECT_TYPE", "Argument 'arg3' has invalid value. Expected type 'Date', found \"3\".", 1, 8)]
    [InlineData("""{ str (arg3: {}) }""", null, false, "INVALID_LITERAL", "Invalid literal for field 'str' argument 'arg3'. Unable to convert 'GraphQLParser.AST.GraphQLObjectValueFull' literal from AST representation to the scalar type 'Date'", 1, 14)]
    [InlineData("""{ str (arg3: {}) }""", null, true, "ARGUMENTS_OF_CORRECT_TYPE", "Argument 'arg3' has invalid value. Expected type 'Date', found {}.", 1, 8)]
    [InlineData("""{ str (arg4: "3") }""", null, false, "INVALID_LITERAL", "Invalid literal for field 'str' argument 'arg4'. Error parsing test literal", 1, 14)]
    [InlineData("""{ str (arg4: "3") }""", null, true, "INVALID_LITERAL", "Invalid literal for field 'str' argument 'arg4'. Error parsing test literal", 1, 14)]
