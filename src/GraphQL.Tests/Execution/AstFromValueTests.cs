...
namespace GraphQL.Tests.Execution
{
    public class AstFromValueTests
    {
        ...
        public void converts_bool_to_boolean_value()
        {
            ...
            result.ShouldNotBeNull();
            result.ShouldBeOfType<BooleanValue>().ClrValue.ShouldBe(true);
        }
        ...
        public void converts_long_to_long_value()
        {
            ...
            result.ShouldNotBeNull();
            result.ShouldBeOfType<LongValue>().ClrValue.ShouldBe(val);
        }
        ...
        public void converts_decimal_to_decimal_value()
        {
            ...
            result.ShouldNotBeNull();
            result.ShouldBeOfType<DecimalValue>().ClrValue.ShouldBe(val);
        }
        ...
        public void converts_int_to_int_value()
        {
            ...
            result.ShouldNotBeNull();
            result.ShouldBeOfType<IntValue>().ClrValue.ShouldBe(val);
        }
        ...
        public void converts_double_to_float_value()
        {
            ...
            result.ShouldNotBeNull();
            result.ShouldBeOfType<FloatValue>().ClrValue.ShouldBe(val);
        }
        ...
        public void converts_byte_to_int_value()
        {
            ...
            result.ShouldNotBeNull();
            result.ShouldBeOfType<IntValue>().ClrValue.ShouldBe(value);
        }
