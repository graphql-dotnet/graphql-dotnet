...
public class ObjectExtensionsTests
{
    ...
    public void toobject_throws_for_invalid_list_type(bool compiled)
    {
        ...
        if (compiled)
        {
            ...
            ex.Message.ShouldBe("Failed to compile input object conversion for CLR type 'MyInput13' and graph type 'MyInput13InputObject': Failed to retrieve a list converter for type 'String' for the list graph type '[Int]': Type 'String' is not a list type or does not have a compatible public constructor.");
            var inner = ex.InnerException.ShouldNotBeNull();
            inner.Message.ShouldBe("Failed to retrieve a list converter for type 'String' for the list graph type '[Int]': Type 'String' is not a list type or does not have a compatible public constructor.");
