...
namespace GraphQL.Utilities
{
    public static class StringUtils
    {
        ...
        {
            foreach (Match match in _words.Matches(str))
            {
