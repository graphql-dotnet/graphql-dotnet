...
namespace GraphQL.Types
{
    ...
    public class ArgumentInformation
    {
        ...
        /// </summary>
        public ArgumentInformation(ParameterInfo parameterInfo, Type sourceType, FieldType fieldType, TypeInformation typeInformation, Expression<Func<IResolveFieldContext, object>>? expression)
        {
            ...
            : this(parameterInfo, sourceType, fieldType, typeInformation, null)
        {
            ...
            {
                Expression = x => x.CancellationToken;
            }
        }
        ...
        /// <summary>
        /// Gets or sets a delegate to be used to populate
        ...
        /// <br/><br/>
        /// The delegate must be of the type Expression&lt;Func&lt;IResolveFieldContext,object&gt;&gt;.
        /// </summary>
        public Expression<Func<IResolveFieldContext, object>>? Expression { get; set; }
        ...
        /// <summary>
        /// Applies <see cref="GraphQLAttribute"/> attributes pulled from the <see cref="ParameterInfo">ParameterInfo</see> onto this instance.
        /// </summary>
