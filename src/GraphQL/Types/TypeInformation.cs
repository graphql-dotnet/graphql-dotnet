...
namespace GraphQL.Types
{
    ...
    public class TypeInformation
    {
        ...
        public TypeInformation(MemberInfo memberInfo, ParameterInfo? parameterInfo, bool isInputType, Type type, bool isNullable, bool isList, bool listIsNullable, Type? graphType)
        {
            MemberInfo = memberInfo ?? throw new ArgumentNullException(nameof(memberInfo));
            if (parameterInfo != null && memberInfo is not MethodInfo)
                throw new ArgumentException($"Specifying {nameof(parameterInfo)} is only valid when {nameof(memberInfo)} represents a {nameof(MethodInfo)}.");
        ...
        public TypeInformation(PropertyInfo propertyInfo, bool isInput)
            : this(propertyInfo, null, isInput, propertyInfo.PropertyType, false, false, false, null)
        {
        ...
        public TypeInformation(FieldInfo fieldInfo, bool isInput)
            : this(fieldInfo, null, isInput, fieldInfo.FieldType, false, false, false, null)
        {
        ...
        public TypeInformation(MethodInfo methodInfo)
            : this(methodInfo, null, false, methodInfo.ReturnType, false, false, false, null)
        {
        ...
        public TypeInformation(ParameterInfo parameterInfo)
            : this(parameterInfo.Member, parameterInfo, true, parameterInfo.ParameterType, false, false, false, null)
        {
