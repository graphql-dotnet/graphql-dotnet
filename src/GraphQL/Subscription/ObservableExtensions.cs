...
internal static class ObservableExtensions
{
    ...
    /// </para>
    /// </summary>
    public static IObservable<TOut> SelectCatchAsync<TIn, TOut>(this IObservable<TIn> source, Func<TIn, CancellationToken, Task<TOut>> transformNext, Func<Exception, CancellationToken, Task<Exception>> transformError)
    ...
    private class SelectCatchAsyncObservable<TIn, TOut> : IObservable<TOut>
    {
        ...
        public SelectCatchAsyncObservable(IObservable<TIn> source, Func<TIn, CancellationToken, Task<TOut>> transformNext, Func<Exception, CancellationToken, Task<Exception>> transformError)
        {
