...
{
    /// <summary>
    /// A field resolver returns an object for a given field within a graph.<br/>
    /// <br/>
    /// The <see cref="FieldType.Resolver"/> property defines the field resolver to be used for the field.<br/>
    /// <br/>
    ...
    /// or <see cref="Builders.FieldBuilder{TSourceType, TReturnType}">FieldBuilder</see>.<see cref="Builders.FieldBuilder{TSourceType, TReturnType}.ResolveAsync(System.Func{IResolveFieldContext{TSourceType}, System.Threading.Tasks.Task{TReturnType}})">ResolveAsync</see>.<br/>
    /// <br/>
    ...
    /// <see cref="ExpressionFieldResolver{TSourceType, TProperty}">ExpressionFieldResolver</see> is used.<br/>
    /// <br/>
    ...
    {
        /// <summary>
        /// Returns an object, null, or a <see cref="Task{TResult}"/> for the specified field. If the task is returned, then this task will be awaited to obtain the actual object.
        /// </summary>
    ...
    {
        /// <summary>
        /// Returns an object or null for the specified field
        /// </summary>
