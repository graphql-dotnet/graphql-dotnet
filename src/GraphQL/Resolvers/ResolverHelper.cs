...
namespace GraphQL.Resolvers
{
    ...
    {
        public static object[] BuildArguments(ParameterInfo[] parameters, ResolveEventStreamContext context)
        {
            ...
            var index = 0;
            if (typeof(ResolveEventStreamContext) == parameters[index].ParameterType)
            {
